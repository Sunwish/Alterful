...
namespace Alterful.GlobalHotKey
{
    ...
    class HotKeyHelper
    {
        ...
        /// 记录快捷键注册项的唯一标识符
        /// </summary>
        private static Dictionary<AHotKeySetting, int> m_HotKeySettingsDic = new Dictionary<AHotKeySetting, int>();
        ...
        public static string RegisterGlobalHotKey(IEnumerable<HotKeyModel> hotKeyModelList, IntPtr hwnd, out Dictionary<AHotKeySetting, int> hotKeySettingsDic)
        {
        ...
        private static bool RegisterHotKey(HotKeyModel hotKeyModel, IntPtr hWnd)
        {
            ...
            var hotKeySetting = (AHotKeySetting)Enum.Parse(typeof(AHotKeySetting), hotKeyModel.Name);
